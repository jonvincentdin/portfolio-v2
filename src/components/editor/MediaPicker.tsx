...
export function MediaPicker({ label, value, onChange, kind = "image" }: { label: string; value?: string; onChange: (value: string | undefined) => void; kind?: "image" | "file" }) {
